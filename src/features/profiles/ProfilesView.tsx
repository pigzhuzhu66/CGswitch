...
function ProfileDragPreview({ profile, width, height, active, busy, subscriptionAuthed, balanceInfo, balanceError, onOpenAdmin }: { profile: ProfileSummary; width: number | null; height: number | null; active: boolean; busy: boolean; subscriptionAuthed: boolean; balanceInfo: ProfileBalanceInfo | null; balanceError: string; onOpenAdmin: () => void }) {
